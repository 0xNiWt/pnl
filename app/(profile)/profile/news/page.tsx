            ...
            <div className="w-full max-w-7xl mx-auto px-5 py-10 md:py-16">
                ...
                <div className="flex items-center justify-between gap-4 mb-8">
                    ...
                    <Link
                        ...
                        className="flex-shrink-0 flex items-center gap-2 rounded-none bg-primary py-3 px-5 text-sm font-bold text-background tracking-wide hover:bg-primary/90 active:scale-[0.99] transition-all"
                    >
                        <FileEdit size={16} />
                        Створити
                    </Link>
