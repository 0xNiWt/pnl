...
export default function Hero() {
    ...
    return (
        <section className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-[1.1fr_0.9fr] items-start md:items-center gap-8 md:gap-12 px-5 md:px-6 py-10 md:py-24" id="hero">
