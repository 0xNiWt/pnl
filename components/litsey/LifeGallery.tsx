...
const SHOTS: Shot[] = [
    {
        src: turslet,
        alt: "Турзліт ліцею: змагання, шахи, намети та спільна кухня на природі",
        tag: "Турзліт",
...
export default function LifeGallery() {
    return (
        ...
        >
            ...
            <h2 className="font-cormorant font-bold text-primary text-[clamp(2rem,1.2rem+2.6vw,3.5rem)] leading-[1.02] tracking-[-0.02em] mb-4 max-w-xl">
                Не тільки формули
            </h2>

            <p className="text-base text-primary/85 max-w-xl mb-10">
                Турзльоти, спортивні турніри, толоки й ліцейські свята — те, через що
