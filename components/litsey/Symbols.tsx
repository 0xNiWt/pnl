        ...
        >
            ...
            <div className="grid grid-cols-1 md:grid-cols-[0.8fr_1.2fr] gap-5 items-start">
                ...
                <div className="md:sticky md:top-28 rounded-none border border-primary/10 bg-primary/[0.03] p-7 md:p-9 flex flex-col items-center text-center">
                    ...
                    <h3 className="font-cormorant font-semibold text-primary text-xl">Герб ліцею</h3>
                ...
                {/* Гімн */}
                <div className="relative overflow-hidden rounded-none bg-primary p-7 md:p-10 text-background">
                    <div className="relative">
                        ...
                        <p className="mt-8 pt-5 border-t border-background/15 font-plex text-xs uppercase tracking-[0.14em] text-background/50">
