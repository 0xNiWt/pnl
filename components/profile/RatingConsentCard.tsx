...
export default function RatingConsentCard() {
    ...
    return (
        <div className="bg-accent/[0.07] border border-accent/30 rounded-2xl p-6">
            ...
            <label className="flex items-start gap-3 rounded-xl border border-primary/10 bg-background/60 p-3.5 cursor-pointer">
                <input
                    type="checkbox"
                    checked={agreed}
            ...
            <button
                ...
                className="mt-4 inline-flex items-center gap-2 bg-primary text-background font-manrope font-semibold text-sm rounded-full px-5 py-2.5 hover:bg-primary/90 transition-colors disabled:opacity-50"
            >
