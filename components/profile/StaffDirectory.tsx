...
const DEPARTMENTS: Department[] = [
    {
        ...
        members: [
            ...
            { name: 'Заболотня Олена Федорівна', position: "Тимчасово виконуюча обов'язки директора, учитель вищої категорії, учитель-методист, відмінник освіти, учитель української мови та літератури", photo: '/staff/zabolotnya.jpg' },
            { name: 'Федорів Любомир Атанасійович', position: 'Тимчасово виконуючий обов'язки директора,, методист, Заслужений вчитель України, вчитель інформатики', photo: '/staff/fedoriv-lyubomyr.jpg' },
            ...
            { name: 'Гуменюк Ярослав Олександрович', position: 'Заступник директора, вчитель фізики, кандидат фізико-математичних наук, випускник ліцею 1990 року', photo: '/staff/gumenyuk.jpg' },
        ],
    },
    {
