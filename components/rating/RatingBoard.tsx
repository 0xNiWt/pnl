...
const RATING_HINTS: Record<RatingKind, string> = {
    points: 'Сума балів за п\'ятьма категоріями активності (п. 10.1.6 Положення).',
    academic: 'За середнім навчальним балом за підсумками першого семестру (п. 10.1.6).',
    olympiad: 'За сумою здобутків на предметних олімпіадах та конкурсі-захисті МАН (п. 10.1.10).',
    overall:
        'Сума місць за трьома попередніми рейтингами. Найменша сума — найвище місце (пп. 10.1.8, 10.2.6).',
};
