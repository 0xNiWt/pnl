...
//   ПРСЛ                        — увесь ліцей, РСЛ і будь-яка група активу;
 ...
 * представники РСЛ, редактори, фізорги та капітани «Ерудиту». Представники
 * РСЛ — це і є склад ради старшокласників ліцею, тож голосування серед них
 * скликає ПРСЛ.
 *
 * Решта класних посад (заступники, культорги, фотографи, волонтери) сюди не
...
export const POSITION_POLL_RIGHTS: Record<string, string[]> = {
  // ПРСЛ і так проходить за загальним правилом нижче, але голова РСЛ
  // записаний тут явно — щоб відповідь на «хто скликає цю групу» лежала
  // в одному місці й збігалася з міграцією sql/0017_rsl_poll_target.sql.
  'prsl': ['rsl-rep'],
